...
/* Definitions for AUTH_Task */
osThreadId_t AUTH_TaskHandle;
const osThreadAttr_t AUTH_Task_attributes = {
  .name = "AUTH_Task",
  .stack_size = 256 * 4,
  .priority = (osPriority_t) osPriorityAboveNormal,
};
/* Definitions for DOOR_Task */
osThreadId_t DOOR_TaskHandle;
const osThreadAttr_t DOOR_Task_attributes = {
  .name = "DOOR_Task",
  .stack_size = 256 * 4,
  .priority = (osPriority_t) osPriorityBelowNormal,
};
/* Definitions for LCD_Tsk */
osThreadId_t LCD_TskHandle;
const osThreadAttr_t LCD_Tsk_attributes = {
  .name = "LCD_Tsk",
  .stack_size = 256 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for rfidQueue */
osMessageQueueId_t rfidQueueHandle;
const osMessageQueueAttr_t rfidQueue_attributes = {
  .name = "rfidQueue"
};
/* Definitions for authQueue */
osMessageQueueId_t authQueueHandle;
const osMessageQueueAttr_t authQueue_attributes = {
  .name = "authQueue"
};
...
/**
* @brief Function implementing the AUTH_Task thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the DOOR_Task thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the LCD_Tsk thread.
* @param argument: Not used
* @retval None
*/
